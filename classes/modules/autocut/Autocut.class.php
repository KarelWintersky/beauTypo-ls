 ...
 * since 2011-02-25
 ********************************************/
  class PluginBeautypo_ModuleAutocut extends Module {
	...
	public function Init() {
		$this->aTagUnbreakable=Config::Get('plugin.beautypo.TagUnbreakable');
		$this->iLengthMax=Config::Get('plugin.beautypo.length_before_cut');
		$this->bLightMode=Config::Get('plugin.beautypo.LightModeOn');
		$this->iLengthLast=Config::Get('plugin.beautypo.SecondBarrier');
	}
  	/*************************************************************
 	* Add cut tag
 	**************************************************************/
